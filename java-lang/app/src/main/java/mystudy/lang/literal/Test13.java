...
public class Test13 {
    public static void main(String[] args) {
        ...
        // 유니코드 문자집합에서 문자 'A'의 문자 코드는 65이다.

        // println()에 숫자를 그냥 전달하면 일반 숫자인줄 알고 그대로 출력한다.
        System.out.println(65);

        // println()에 전달하는 값이 일반적인 수가 아니라 문자 코드임을 지정해야한다.
        ...
        for (int i = 0; i < 26; i++) {
            System.out.println((char) (i + 65) + ","); // ','하면 109부터 출력됨. // 대문자를 표시하려면 ","
        }
    }
}
...
//
// 1) ASCII (7bit)
// - 미국 국가 표준 협회(ANSI)에서 영어 알파벳, 숫자, 특수 문자 등을 컴퓨터에서 저장할 수 있도록 7비트 2진수로 정의한 인코딩
// 규칙
