...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        log.debug("securityFilterChain() 호출됨 => SecurityFilterChain 구성함!");
    ...
    public UserDetailsService userDetailsService() {
        log.debug("UserDetailsService 객체 등록!");
        // 로그인 사용자 정보
...
//        class  MyUserDetailsManager extends InMemoryUserDetailsManager {
//            public MyUserDetailsManager(UserDetails... users) {
//                super(users);
//            }
//
//            @Override
//            public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
//                log.debug("loadUserByUsername() 호출됨!");
...
//        return new MyUserDetailsManager(userDetails);
    }
}
